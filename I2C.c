...
extern void LED_Port(unsigned led_port_data);
...
{    
	...
	//0x00 - Polling Mode
	//0x01 - Trigger Mode
    FT5436_Write_Reg(FT_ID_G_MODE, 0x01);
...
{
    FT5436_Read(16);
    //read_buf[0]                           Device Mode
    //read_buf[1]                           Gesture ID
    //read_buf[2]                           number of touches
    //read_buf[3]                           x high byte
    //read_buf[4]                           x low byte
    //read_buf[5]                           y high byte
    //read_buf[6]                           y low byte
    //read_buf[7]                           touch weight 
    //read_buf[8]                           TOUCH1_MISC 
    //                                          1st Touch Area[3:0] 1stTouch Direction [1:0] 1stTouch Speed [1:0]
    //read_buf[9]                           Gesture ID
    //read_buf[A]                           number of touches
    //read_buf[B]                           x high byte
    //read_buf[C]                           x low byte
    //read_buf[D]                           y high byte
    //read_buf[E]                           y low byte
    //read_buf[F]                           touch weight 
    
    
    LED_Port(read_buf[0x4]);
